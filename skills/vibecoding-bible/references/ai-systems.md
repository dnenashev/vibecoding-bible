...
Токены — не единственная цена. Разделять два класса:

- **дорогие действия** — деплой, migration, запрос к production, полный прогон CI, платный вызов модели, внешняя мутация, любое необратимое действие;
- **бесплатный вывод** — всё, что выводится из уже собранных артефактов: логи, coverage, схемы, AST, история git, снятые трейсы, предыдущие receipts.

Перед дорогим действием исчерпать бесплатный вывод. Повторный прогон ради факта, который уже лежит в собранных артефактах, — не осторожность, а трата бюджета и времени.
