...
Многошаговый deploy или migration исполнять как последовательность, где каждый шаг несёт своё ожидание наблюдаемого результата, а исполнение останавливается на первом расхождении. Скрипт, который прошёл до конца и разбирается в конце, оставляет систему в неизвестном состоянии посередине.
